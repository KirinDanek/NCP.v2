...
OUT_PATH          = RESULT_DIR / "lrp_comparison_subspace3.png"
...
def _run_lrp(modules_bwd, first_conv, R):
    """Walk modules in backward order, applying LRP-alpha1-beta0."""
...
def main():
    ...
    fig.suptitle(
        "LRP-α1β0 heatmaps: VGG16 ImageNet vs NCP pruned (subspace 3) vs Vanilla pruned",
        fontsize=11,
    )
    plt.tight_layout()
