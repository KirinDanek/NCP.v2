# Concept-Aware Pruning Pipeline (Augmented VGG16 + LRP)

This repo implements an iterative **pruning + fine-tuning (PFT)** pipeline for VGG16, with an optional
**concept-based “virtual layer” augmentation** inserted at `conv4_3`. The augmentation performs concept-based ablations, which facilitates CNP. Filters are ranked for pruning using
**Layer-wise Relevance Propagation (LRP)** and removed structurally (channel surgery).

This work was presented at the XAI4CV workshop at CVPR 2026.

This readme was generated by AI and edited by a human (me). It's a bit tedious to read but is a good comprehensive description of the implementation here. If you're interested in the theory rather than the code, check out [this paper](https://xai4cv-workshop.github.io/xai4cv2026/assets/papers/PP29.pdf), which was written by humans. 
